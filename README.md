...
2.  Install [libpng](http://www.libpng.org/pub/png/libpng.html).
    ...
    *   On Mageia, do `urpmi libpng-devel gcc-g++`, or `dnf install libpng-devel gcc-g++`, or install the binary from the Mageia Cauldron repositoy using `urpmi guetzli` or `dnf install guetzli`.
